...
marital_status: chr  Categoriacl variable - nominal variable
occupation    : chr  Categorical variable - nominal varaiable
relationship  : chr  Categoriacl variable - nominal variable
race          : chr  Categoriacl variable - nominal variable
sex           : chr  Categoriacl variable - nominal variable
capital_gain  : int  Numerical variable - discrete in nature
capital_loss  : int  numerical variable and discrete integree variable
hours_per_week: int  numerical variable and discrete integree variable
native_country: chr  Categorical variable - nominal varaiable
income        : chr  Categorical variable - nominal varaiable
